...
const Skills = () => {
  const skills = [
    ...
    { image: "/images/skills/zustand.png", text: "Zustand" },
    // { image: "/images/skills/python.png", text: "Python" },
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <p className=" text-[18px] text-center">
          This includes tools, languages and frameworks which I use to bring my
          projects to life. Each one helps me build efficient and creative
          applications while detailing precision, peak performance and best
          security practices.
        </p>

        {/* skills display */}
        <div className="w-full grid py-[2rem]  md:grid-cols-5 sm:grid-cols-3 grid-cols-3 gap-5">
